## USE THIS FOR THE Z SEGMENTATION STUDIES
import numpy as np
import os
...
if __name__=="__main__":
    ...
    parser.add_argument('--config', default='configs/default_ucr_zseg.yaml')
    ...
    print('zzzzzzzzzzzzzzzzzz', num_z_layers, '    ' , output_dir)
    ...
    print('  ',num_z_layers, '   ',  len(root_train_files), 'hadronic detector', hadronic_detector, '  ecal status ',include_ecal)
    '''       
    #Generators
